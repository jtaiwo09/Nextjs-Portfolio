  ...
  return (
    <div className="relative sm:hidden">
      <div
        ...
        className={`w-[40px] h-[40px] p-2 flex justify-center items-center fixed top-[10px] right-[10px] z-20 cursor-pointer`}
      >
        <span
          className={`nav__toggler h-[2px] w-[24px] switch__bg inline-block relative before:content-[''] before:absolute before:h-[2px] before:w-[60%] before:-translate-y-2 after:content-[''] after:absolute after:h-[2px] after:w-[60%] after:translate-y-2 after:right-0 transition-all before:duration-[0.3s] after:duration-[0.3s] ${
            open &&
